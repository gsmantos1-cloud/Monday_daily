...
export function Modal({ open, onClose, title, children, size = 'md' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div
        className={`relative w-full ${widths[size]} max-h-[90vh] flex flex-col overflow-hidden rounded-2xl shadow-2xl border`}
        style={{ backgroundColor: '#141414', borderColor: '#2a2a2a' }}
        onClick={e => e.stopPropagation()}
      >
        {/* Gold top accent */}
        <div className="h-0.5 rounded-t-2xl flex-shrink-0" style={{ background: 'linear-gradient(90deg, #D4AF37, #f0d060, #D4AF37)' }} />
